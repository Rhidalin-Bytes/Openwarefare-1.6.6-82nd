...
init()
{
	...
	addLeagueRuleset( "pub_softcore_bolts", "all", rulesets\openwarfare\public\pub_softcore_bolts::setRuleset );
	addLeagueRuleset( "pub_hardcore_bolts", "all", rulesets\openwarfare\public\pub_hardcore_bolts::setRuleset );
	addLeagueRuleset( "pub_tactical_bolts", "all", rulesets\openwarfare\public\pub_tactical_bolts::setRuleset );
	...
	addLeagueRuleset( "match_softcore_bolts", "all", rulesets\openwarfare\match\match_softcore_bolts::setRuleset );
	addLeagueRuleset( "match_hardcore_bolts", "all", rulesets\openwarfare\match\match_hardcore_bolts::setRuleset );
	addLeagueRuleset( "match_tactical_bolts", "all", rulesets\openwarfare\match\match_tactical_bolts::setRuleset );
