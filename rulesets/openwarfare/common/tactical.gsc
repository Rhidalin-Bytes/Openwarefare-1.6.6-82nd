...
init()
{
	...
	setDvar( "scr_hardpoint_allow_radar", "0" );
	setDvar( "scr_hardpoint_artillery_streak", "7" );
	setDvar( "scr_announce_enemy_artillery_inbound", "0" );
	setDvar( "scr_hardpoint_allow_dogs", "0" );
	...
	setDvar( "scr_betty_show_headicon", "0" );
	setDvar( "scr_betty_detonate_radius", "50" );
	setDvar( "scr_betty_arm_time", "4" );
	setDvar( "scr_betty_line_of_sight", "1" );
	setDvar( "scr_betty_friendly_fire", "1" );
