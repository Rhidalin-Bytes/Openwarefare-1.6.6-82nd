...
init()
{
	...
	setDvar( "scr_gg_weapon_order", "colt_mp;walther_mp;tokarev_mp;357magnum_mp;doublebarreledshotgun_mp;shotgun_mp;springfield_mp;kar98k_mp;m1garand_mp;gewehr43_mp;m1carbine_mp;thompson_mp;mp40_mp;ppsh_mp;stg44_mp;bar_mp;fg42_mp;dp28_mp;30cal_mp;frag_grenade_mp:1;knife_mp:1" );
	...
	setDvar( "scr_gg_nade_knife_weapon", "satchel_charge_mp:0" );
	...
	//******************************************************************************
	// configs/gametypes/war.cfg
	//******************************************************************************
	setDvar( "scr_twar_scorelimit", "5" );
	setDvar( "scr_twar_timelimit", "10" );
	setDvar( "scr_twar_roundlimit", "2" );
	setDvar( "scr_twar_roundswitch", "1" );
	setDvar( "scr_twar_numlives", "0" );
	...
	setDvar( "scr_twar_flash_on_capture", "0" );
	setDvar( "scr_twar_teambalanceendofround", "0" );		
}