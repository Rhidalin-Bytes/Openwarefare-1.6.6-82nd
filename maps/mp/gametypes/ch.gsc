...
onPrecacheGameType()
{
	...
	if ( game["allies"] == "marines" ) {
		...
		game[level.gameType]["prop_flag_allies_carry"] = "hudicon_american_ctf_flag_carry";
		game[level.gameType]["hud_flag_allies"] = "objpoint_flag_american";
		game[level.gameType]["flag_base_allies"] = loadFX( "misc/ui_flagbase_blue" );
	} else {
		game[level.gameType]["prop_flag_allies"] = "prop_flag_russian";
		game[level.gameType]["prop_flag_allies_carry"] = "hudicon_russian_ctf_flag_carry";
		game[level.gameType]["hud_flag_allies"] = "objpoint_flag_russian";
		game[level.gameType]["flag_base_allies"] = loadFX( "misc/ui_flagbase_orange" );
	}
	...
	if ( game["axis"] == "german" ) {
		game[level.gameType]["prop_flag_axis"] = "prop_flag_german";
		game[level.gameType]["prop_flag_axis_carry"] = "hudicon_german_ctf_flag_carry";
		game[level.gameType]["hud_flag_axis"] = "objpoint_flag_german";
		game[level.gameType]["flag_base_axis"] = loadFX( "misc/ui_flagbase_gold" );
	} else {
		game[level.gameType]["prop_flag_axis"] = "prop_flag_japanese";
		game[level.gameType]["prop_flag_axis_carry"] = "hudicon_japanese_ctf_flag_carry";
		game[level.gameType]["hud_flag_axis"] = "objpoint_flag_japanese";
...
onStartGameType()
{
	...
	level.spawn_axis = maps\mp\gametypes\_spawnlogic::getSpawnpointArray( "mp_" + spawnType + "_spawn_" + level.axisAssets );
	level.spawn_allies = maps\mp\gametypes\_spawnlogic::getSpawnpointArray( "mp_" + spawnType + "_spawn_" + level.alliesAssets );
	level.spawn_axis_start = maps\mp\gametypes\_spawnlogic::getSpawnpointArray( "mp_" + spawnType + "_spawn_" + level.axisAssets + "_start" );
	level.spawn_allies_start = maps\mp\gametypes\_spawnlogic::getSpawnpointArray( "mp_" + spawnType + "_spawn_" + level.alliesAssets + "_start" );
...
onPickup( player )
{
	...
	player thread maps\mp\gametypes\_gameobjects::attachUseModel( game[level.gameType]["prop_flag_" + self.ownerTeam + "_carry" ], "tag_stowed_back", true );
