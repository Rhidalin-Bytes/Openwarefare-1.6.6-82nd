...
main()
{
	...
	level.scr_dm_safespawns = getdvarx( "scr_dm_safespawns", "int", 0, 0, 1  );
	...
	if ( level.scr_unified_spawns_enable == 1 && level.scr_dm_safespawns == 0 ) {
