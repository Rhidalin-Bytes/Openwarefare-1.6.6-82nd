...
main()
{
	...
	level.scr_twar_flash_on_capture = getdvarx( "scr_twar_flash_on_capture", "int", 1, 0, 2 );
...
flagNeutralTimer()
{
	...
	if ( time && level.flagSetupComplete )
	{
		...
		switch ( level.scr_twar_flash_on_capture ) {
			case 1:
...
twar_remove_spawn_influencers()
{
	...
	{
		if ( isDefined( level.twar_influencers[i] ) )
