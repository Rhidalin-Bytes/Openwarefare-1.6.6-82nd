...
cac_init()
{
	...
	level.allowedPerks[0][ 4] = perkAllowed( "specialty_specialgrenade", perkReferenceToIndex );
	level.allowedPerks[0][ 5] = perkAllowed( "specialty_weapon_bouncing_betty", perkReferenceToIndex );
	level.allowedPerks[0][ 6] = perkAllowed( "specialty_fraggrenade", perkReferenceToIndex );
	level.allowedPerks[0][ 7] = perkAllowed( "specialty_extraammo", perkReferenceToIndex );
	level.allowedPerks[0][ 8] = perkAllowed( "specialty_detectexplosive", perkReferenceToIndex );
	level.allowedPerks[0][ 9] = perkAllowed( "specialty_weapon_flamethrower", perkReferenceToIndex );
	level.allowedPerks[0][10] = perkAllowed( "specialty_weapon_bazooka", perkReferenceToIndex );
	level.allowedPerks[0][11] = perkAllowed( "specialty_weapon_satchel_charge", perkReferenceToIndex );

	level.allowedPerks[1][ 0] = 190;
	level.allowedPerks[1][ 1] = perkAllowed( "specialty_bulletdamage", perkReferenceToIndex );
	level.allowedPerks[1][ 2] = perkAllowed( "specialty_armorvest", perkReferenceToIndex );
	level.allowedPerks[1][ 3] = perkAllowed( "specialty_fastreload", perkReferenceToIndex );
	level.allowedPerks[1][ 4] = perkAllowed( "specialty_rof", perkReferenceToIndex );
	level.allowedPerks[1][ 5] = perkAllowed( "specialty_twoprimaries", perkReferenceToIndex );
	level.allowedPerks[1][ 6] = perkAllowed( "specialty_gpsjammer", perkReferenceToIndex );	
	level.allowedPerks[1][ 7] = perkAllowed( "specialty_explosivedamage", perkReferenceToIndex );
	level.allowedPerks[1][ 8] = perkAllowed( "specialty_flakjacket", perkReferenceToIndex );
	level.allowedPerks[1][ 9] = perkAllowed( "specialty_shades", perkReferenceToIndex );
	level.allowedPerks[1][10] = perkAllowed( "specialty_gas_mask", perkReferenceToIndex );
	
	level.allowedPerks[2][ 0] = 190;
	level.allowedPerks[2][ 1] = perkAllowed( "specialty_longersprint", perkReferenceToIndex );
	level.allowedPerks[2][ 2] = perkAllowed( "specialty_bulletaccuracy", perkReferenceToIndex );
	level.allowedPerks[2][ 3] = perkAllowed( "specialty_pistoldeath", perkReferenceToIndex );
	level.allowedPerks[2][ 4] = perkAllowed( "specialty_grenadepulldeath", perkReferenceToIndex );
	level.allowedPerks[2][ 5] = perkAllowed( "specialty_bulletpenetration", perkReferenceToIndex );
	level.allowedPerks[2][ 6] = perkAllowed( "specialty_holdbreath", perkReferenceToIndex );
	level.allowedPerks[2][ 7] = perkAllowed( "specialty_quieter", perkReferenceToIndex );
	level.allowedPerks[2][ 8] = perkAllowed( "specialty_fireproof", perkReferenceToIndex );
	level.allowedPerks[2][ 9] = perkAllowed( "specialty_reconnaissance", perkReferenceToIndex );
	level.allowedPerks[2][10] = perkAllowed( "specialty_pin_back", perkReferenceToIndex );

	level.allowedPerks[3][ 0] = 190;
	level.allowedPerks[3][ 1] = perkAllowed( "specialty_water_cooled", perkReferenceToIndex );
	level.allowedPerks[3][ 2] = perkAllowed( "specialty_greased_barrings", perkReferenceToIndex );
	level.allowedPerks[3][ 3] = perkAllowed( "specialty_ordinance", perkReferenceToIndex );
	level.allowedPerks[3][ 4] = perkAllowed( "specialty_boost", perkReferenceToIndex );
	level.allowedPerks[3][ 5] = perkAllowed( "specialty_leadfoot", perkReferenceToIndex );
}

perkAllowed( perkName, perkReferenceToIndex ) {
	if ( getdvarx( "perk_allow_" + perkName, "int", 1, 0, 1 ) ) {
		return perkReferenceToIndex[ perkName ];
	}
	return 0;
}
...
get_specialtydata( class_num, specialty )
{
	...
	if( specialty == "specialty1" )
	{
		if( isSubstr( cac_group, "grenade" ) )
		{
			...
			self.custom_class[class_num]["grenades_count"] = game["loadout_" + class + "_primary_count"];
			...
			self.custom_class[class_num]["specialgrenades_count"] = game["loadout_" + class + "_secondary_count"];
...
giveLoadout( team, class )
{
	...
	*/
	...
	{	
		...
		self cac_getdata( ( self getstat(251) > 64 ) );
...
getPlayerCustomClass( primaryWeapon )
{
	...
	switch ( weaponClass( primaryWeapon ) )
	{
		...
		case "mg":
			...
			break;
		case "smg":
			playerClass = "CLASS_LIGHTGUNNER";
			break;
		case "spread":
			playerClass = "CLASS_CLOSEASSAULT";
			break;
	}
