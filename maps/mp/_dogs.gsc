...
dog_dvar_update()
{
	level.dog_time = getdvarx( "scr_dog_time", "int", 60, 15, 120 );
	level.dog_health = getdvarx( "scr_dog_health", "int", 100, 30, 200 );
	level.dog_count = getdvarx( "scr_dog_count", "int", 8, 1, 20 );
	level.dog_count_max_at_once = getdvarx( "scr_dog_max_at_once", "int", 4, 1, 20 );
