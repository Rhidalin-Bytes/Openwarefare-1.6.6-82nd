...
onPlayerSpawned()
{
	...
	switch ( self.pers["team"] ) {
		case "allies":
			switch ( game["allies"] ) {
				case "russian":
					self.myDeathSound = "generic_death_russian";
					self.myPainSound = "generic_pain_russian";
					break;
				case "marines":
				default:
					self.myDeathSound = "generic_death_american";
					self.myPainSound = "generic_pain_american";
					break;
			}
			break;
		case "axis":
			switch ( game["axis"] ) {
				case "japanese":
					self.myDeathSound = "generic_death_japanese";
					self.myPainSound = "generic_pain_japanese";
					break;
				case "german":
				default:
					self.myDeathSound = "generic_death_german";
					self.myPainSound = "generic_pain_german";
					break;
			}
			break;
		default:
