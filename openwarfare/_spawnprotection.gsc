...
// 82ndAB Changes:	dvar added: scr_spawn_protection_disableWeapons - disables weapons during spawn protection
//					function added: ceasefire() - disables weapons indefinitely
//******************************************************************************
...
init()
{
	...
	level.scr_spawn_protection_disableWeapons = getdvarx( "scr_spawn_protection_disableWeapons", "int", 0, 0, 1 );
...
ceasefire()
{
	...
	for (;;)
	{	
		level.scr_enable_ceasefire = getdvarx( "scr_enable_ceasefire", "int", 0, 0, 1 );
			wait (0.05);
				if ( level.scr_enable_ceasefire == 1 ){
					self maps\mp\gametypes\_gameobjects::_ceasefire();
				}
				else if ( level.scr_enable_ceasefire == 0 && openwarfare\_healthsystem::player_is_bleeding() != true) {
					self maps\mp\gametypes\_gameobjects::_enableWeapon();
				}
	}
