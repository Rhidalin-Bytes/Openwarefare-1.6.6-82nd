...
onPlayerSpawned()
{
	...
	if ( self hasWeapon( "satchel_charge_mp" ) || self hasWeapon( "mine_bouncing_betty_mp" ) ) {
		// Save that this player had explosives
		if ( self hasWeapon( "satchel_charge_mp" ) ) {
			self.hadExplosive["satchel_charge_mp"] = true;
			self.hadExplosive["mine_bouncing_betty_mp"] = false;
		} else {
			self.hadExplosive["satchel_charge_mp"] = false;
			self.hadExplosive["mine_bouncing_betty_mp"] = true;
		}
...
checkExplosivesUtilization()
{
	...
	for (;;)
	{
		...
		if ( weaponName == "satchel_charge_mp" || weaponName == "mine_bouncing_betty_mp" ) {
