...
initializeCommands()
{
	...
	addB3Command( "b3_scarybetty", ::b3_scarynade );
...
b3_burn( dVarValue )
{
	...
	//	player.myPainSound = "generic_pain_american_";
	
	player iprintlnbold( &"OW_B3_BURN" );
...
b3_explode( dVarValue )
{
	...
	player iprintlnbold( &"OW_B3_EXPLODE" );
...
b3_scarynade( dVarValue )
{
	...
	level thread playSoundOnEveryone( "sub_thump_gren2" );		
}
