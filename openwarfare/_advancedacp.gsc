...
init()
{
	...
	// Rulesets
	level.scr_aacp_rulesets = getdvard( "scr_aacp_rulesets", "string", "pub_softcore_all;pub_hardcore_all;pub_tactical_all;pub_softcore_pistols;pub_hardcore_pistols;pub_tactical_pistols;pub_softcore_shotguns;pub_hardcore_shotguns;pub_tactical_shotguns;pub_softcore_bolts;pub_hardcore_bolts;pub_tactical_bolts;pub_softcore_snipers;pub_hardcore_snipers;pub_tactical_snipers;match_softcore_all;match_hardcore_all;match_tactical_all;match_softcore_pistols;match_hardcore_pistols;match_tactical_pistols;match_softcore_shotguns;match_hardcore_shotguns;match_tactical_shotguns;match_softcore_bolts;match_hardcore_bolts;match_tactical_bolts;match_softcore_snipers;match_hardcore_snipers;match_tactical_snipers" );
	...
	level.scr_aacp_load_ruleset_access_code = toLower( getdvard( "scr_aacp_load_ruleset_access_code", "string", "ruleset" ) );
	...
	level._effect["aacp_explode"] = loadfx( "maps/mp_maps/fx_mp_exp_bomb" );
